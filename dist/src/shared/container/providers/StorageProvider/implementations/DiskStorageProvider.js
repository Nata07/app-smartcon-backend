    ...
    DiskStorageProvider.prototype.saveFile = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_1.default.promises.rename(path_1.default.resolve(upload_1.default.tempFolder, file), path_1.default.resolve(upload_1.default.uploadFolder, file))];
                    case 1:
                        _a.sent();
