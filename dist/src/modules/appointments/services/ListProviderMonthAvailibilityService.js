...
var ListProviderMonthAvailabilityService = /** @class */ (function () {
    function ListProviderMonthAvailabilityService(appointmentRespository) {
    ...
    ListProviderMonthAvailabilityService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.appointmentRespository.findAllInMOnthFromProvider({
                    ...
                    case 1:
                        ...
                        availability = eachDayArray.map(function (day) {
                            ...
                            var appoinmentsInDay = appointments.filter(function (appointment) {
                                return date_fns_1.getDate(appointment.date) === day;
                            });
                            return {
                                day: day,
                                available: date_fns_1.isAfter(compareDate, new Date()) && appoinmentsInDay.length < 10,
                            };
                        });
