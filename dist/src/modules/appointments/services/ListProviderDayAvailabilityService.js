...
var ListProviderDayAvailabilityService = /** @class */ (function () {
    function ListProviderDayAvailabilityService(appointmentRespository) {
    ...
    ListProviderDayAvailabilityService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointments, hourStart, eachHourArray, currentDate, availavility;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.appointmentRespository.findAllInDayFromProvider({
