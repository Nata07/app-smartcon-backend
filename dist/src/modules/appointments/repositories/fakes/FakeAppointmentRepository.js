...
var FakeAppointmentRepository = /** @class */ (function () {
    ...
    FakeAppointmentRepository.prototype.findByDate = function (date, provider_id) {
    ...
    FakeAppointmentRepository.prototype.findAllInMOnthFromProvider = function (_a) {
        var provider_id = _a.provider_id, month = _a.month, year = _a.year;
        return __awaiter(this, void 0, void 0, function () {
            var findAppointment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.appointments.filter(function (appointment) {
    ...
    FakeAppointmentRepository.prototype.findAllInDayFromProvider = function (_a) {
