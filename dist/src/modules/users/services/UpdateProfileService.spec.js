...
describe('UpdateProfile', function () {
    beforeEach(function () {
        ...
        updateProfile = new UpdateProfileService_1.default(fake, fakeHash);
    });
    ...
    it('should not be able to create user with existing email ', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fake.create({
