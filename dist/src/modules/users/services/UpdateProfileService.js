...
var UpdateProfileService = /** @class */ (function () {
    function UpdateProfileService(usersRespository, hashProvider) {
        this.usersRespository = usersRespository;
        this.hashProvider = hashProvider;
    }
    UpdateProfileService.prototype.execute = function (_a) {
        var name = _a.name, email = _a.email, user_id = _a.user_id, password = _a.password, old_password = _a.old_password;
        return __awaiter(this, void 0, void 0, function () {
            var user, userExists, checkPassword, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.usersRespository.findById(user_id)];
                    case 1:
                        user = _c.sent();
                        if (!user) {
                            throw new AppError_1.default('user not found');
                        }
                        return [4 /*yield*/, this.usersRespository.findByEmail(email)];
                    case 2:
                        userExists = _c.sent();
                    ...
                    case 4:
                        _b.password = _c.sent();
                        _c.label = 5;
                    case 5: return [2 /*return*/, this.usersRespository.save(user)];
                }
            });
        });
    };
