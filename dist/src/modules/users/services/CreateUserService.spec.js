...
describe('CreateUser', function () {
    beforeEach(function () {
        ...
        createUser = new CreateUserService_1.default(fake, fakeHash, fakeCacheProvider);
    });
    ...
    it('should not be able to create two User on the same email from another', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createUser.execute({
                        name: 'John Doe',
