...
var UploadUserAvatarService_1 = __importDefault(require("./UploadUserAvatarService"));
var fake;
var fakeStorage;
var updateUserAvatar;
describe('UploadUserAvatar', function () {
    beforeEach(function () {
        fake = new FakeUsersRepository_1.default();
        fakeStorage = new FakeStorageProvider_1.default();
        updateUserAvatar = new UploadUserAvatarService_1.default(fake, fakeStorage);
    });
    it('should be able to create a new User', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fake.create({
                        name: 'John Doe',
                        email: 'jn@email.com',
                        password: '123456',
                    })];
    ...
    it('non exist user update avatar', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    it('should delete user avatar when upload new one', function () { return __awaiter(void 0, void 0, void 0, function () {
        var deleteFile, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    deleteFile = jest.spyOn(fakeStorage, 'deleteFile');
                    return [4 /*yield*/, fake.create({
                            name: 'John Doe',
                            email: 'jn@email.com',
                            password: '123456',
                        })];
