...
describe('SendForgotPasswordEmail', function () {
    beforeEach(function () {
        ...
        fakeEmailProvider = new FakeMailProvider_1.default();
        fakeUserToken = new FakeUserTokensRepository_1.default();
        sendForgotEmail = new SendForgotPasswordEmailService_1.default(fakeUser, fakeEmailProvider, fakeUserToken);
    });
    it('should be able to recover password using email', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    sendEmail = jest.spyOn(fakeEmailProvider, 'sendEmail');
                    return [4 /*yield*/, fakeUser.create({
                            name: 'Jhon Doe',
                            email: 'jn@email.com',
                            password: '123456',
                        })];
    ...
    it('should not recover password to inexist user ', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should generate a forgot password token', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    generate = jest.spyOn(fakeUserToken, 'generate');
                    return [4 /*yield*/, fakeUser.create({
                            name: 'Jhon Doe',
                            email: 'jn@email.com',
                            password: '123456',
