...
var CreateuserService = /** @class */ (function () {
    function CreateuserService(userRepository, hashProvider, cacheRepository) {
        this.userRepository = userRepository;
        this.hashProvider = hashProvider;
        this.cacheRepository = cacheRepository;
    }
    CreateuserService.prototype.execute = function (_a) {
        var name = _a.name, email = _a.email, phone = _a.phone, type = _a.type, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            var duplicatedEmail, hashedPassword, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (duplicatedEmail) {
                            throw new AppError_1.default('Email address alredy used');
                        }
                    ...
                    case 3:
                        user = _b.sent();
                        return [4 /*yield*/, this.cacheRepository.invalidadePrefix('providers-list')];
                    case 4:
                        _b.sent();
