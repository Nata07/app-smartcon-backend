...
var ProfileController = /** @class */ (function () {
    ...
    ProfileController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var user_id, _a, email, name, password, oldPassword, authenticateUser, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        user_id = request.user.id;
                        _a = request.body, email = _a.email, name = _a.name, password = _a.password, oldPassword = _a.oldPassword;
                        authenticateUser = tsyringe_1.container.resolve(UpdateProfileService_1.default);
